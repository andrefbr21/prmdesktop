...
public class ConsultaConversasDoGrupoDeRelacionamentos implements ConsultaConversas {
    
    private Object lock = new Object();
    
    public ConsultaConversasDoGrupoDeRelacionamentos() {}
    ...
    public Map<Relacionamento, List<Conversa>> recuperaConversasDoDia(Calendar calendar, Object objetoSelecionado) {
        synchronized(lock) {
            ...
            if (objetoSelecionado.getClass() == GrupoDeRelacionamentos.class) {
                GrupoDeRelacionamentos grupo = (GrupoDeRelacionamentos) objetoSelecionado;
